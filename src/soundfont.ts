...
function getUrlBuilder(
  ...
  return library === undefined
    ? (instrument, format) =>
        gleitzKitUrl("MusyngKite", instrument, format ?? "ogg")
    : typeof library === "function"
    ? library
    : (library.url as LibraryUrlBuilder);
}
...
export type LibraryUrlBuilder = (instrument: string, format?: string) => string;

export type SoundfontLibrary = {
  name: string;
  url: (name: string, format?: "ogg" | "mp3") => string;
  instruments: string[];
};

export const FluidR3: SoundfontLibrary = {
  name: "FluidR3_GM",
  url: (name: string, format: "ogg" | "mp3" = "mp3") =>
    gleitzKitUrl("FluidR3_GM", name, format),
  instruments: [
    "accordion",
    "acoustic_bass",
...
export const MusyngKite: SoundfontLibrary = {
  name: "MusyngKite",
  url: (name: string, format: "ogg" | "mp3" = "mp3") =>
    gleitzKitUrl("MusyngKite", name, format),
  instruments: [
    "accordion",
    "acoustic_bass",
    "acoustic_grand_piano",
...
export const SoundfontLibraries: Record<string, SoundfontLibrary> = {
  FluidR3,
  MusyngKite,
};
